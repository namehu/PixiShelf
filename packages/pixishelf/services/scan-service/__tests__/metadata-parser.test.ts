...
describe('parseMetadataFile', () => {
  it('should parse pixiv json metadata into normalized metadata', async () => {
    ...
    expect((result.metadata as any).likeCount).toBeUndefined()
    expect((result.metadata as any).pageCount).toBeUndefined()
    expect((result.metadata as any).pageIndex).toBeUndefined()
    expect((result.metadata as any).width).toBeUndefined()
    expect((result.metadata as any).height).toBeUndefined()
    expect((result.metadata as any).viewCount).toBeUndefined()
    expect((result.metadata as any).commentCount).toBeUndefined()
    expect((result.metadata as any).seriesTitle).toBeUndefined()
    expect((result.metadata as any).sourceSeriesId).toBeUndefined()
    expect((result.metadata as any).seriesOrder).toBeUndefined()
  })

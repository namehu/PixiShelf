...
const ArtistsNavigation = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      setQueryStates({ search: searchValue || null })
    }, 300)

    return () => clearTimeout(timer)
  }, [searchValue, currentSearch, setQueryStates])
  ...
  return (
    <PNav showUserMenu={false}>
      <div className="flex items-center gap-2 md:gap-3 w-full pr-2 md:pr-4">
        ...
        >
          <Select value={currentSortBy} onValueChange={handleSort}>

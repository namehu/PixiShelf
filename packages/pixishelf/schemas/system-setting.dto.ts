...
export const SYSTEM_SETTING_KEYS = {
  ...
  archiveDefaultTagIds: 'archive_default_tag_ids'
} as const
...
export const systemSettingsSchema = z.object({
  ...
  archive_default_tag_ids: z.array(z.coerce.number().int().positive()).optional()
})
...
export const systemSettingsWithDefaultsSchema = systemSettingsSchema.default({}).transform((settings) => ({
  ...
  archive_default_tag_ids: settings.archive_default_tag_ids ?? []
}))
...
export const updateSystemSettingsSchema = z.object({
  ...
  archive_default_tag_ids: z.array(z.number().int().positive()).optional()
})

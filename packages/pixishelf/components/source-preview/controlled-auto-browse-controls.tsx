...
export function ControlledAutoBrowseControls({
  mode,
  current,
  total,
  state,
    ...
    const schedule = () => {
      ...
      timer = setTimeout(() => {
        if (
          ...
          schedule()
        } else onSetControlsCollapsed(true)
      }, 4000)
    }
    const keyboard = () => {
      keyboardInput = true
  ...
  }, [collapsed, onSetControlsCollapsed, playing, settingsOpen])

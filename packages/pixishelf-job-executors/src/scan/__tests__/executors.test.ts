...
describe('scan executor registrations', () => {
  it('exports strict SCAN and LOCAL_DIRECTORY_IMPORT v1 definitions', () => {
    ...
    expect(
      registrations[1]!.parsePayload?.({ defaultTagIds: [1, 2], mappingCount: 0, mappingDigest: 'b'.repeat(64) })

...
export interface BatchTranslationRequest {
  ...
  onProgress?: (progress: TaskStats) => void;
...
export interface IPixivService {
  ...
  pauseTask(): Promise<ServiceResult>;
  resumeTask(): Promise<ServiceResult>;
  stopTask(): Promise<ServiceResult>;
  ...
  batchTranslate(request: BatchTranslationRequest): Promise<ServiceResult<TranslationResponse[]>>;

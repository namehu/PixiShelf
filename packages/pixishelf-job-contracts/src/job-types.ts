...
export const JOB_EXECUTION_LANE = Object.freeze(
  Object.fromEntries(
    JOB_TYPE_VALUES.map((jobType) => [
      jobType,
      jobType === 'ARCHIVE_RESOLVE_ITEM' || jobType === 'ARCHIVE_UPLOADER_SCAN' || jobType === 'ARCHIVE_SEARCH_SCAN'
        ? EXECUTION_LANES.ARCHIVE_RESOLVE
        : EXECUTION_LANES.BACKGROUND_WRITER
    ])

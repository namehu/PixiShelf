...
健康检查证明进程和两个 lane 的预检状态，capability audit 精确证明 30 个 job type、35 个 type/version 组合
...
Worker 测试和 capability 门禁包含双 lane contract，以及 30 个 job type、35 个 type/version 组合（`SCAN`

---
status: historical
scope: 2026-08-18 阶段 1–7 上线后的稳定观察、阶段 8 门禁和兼容清理清单
last-verified: 2026-08-18
current-source: ../../TODO.md
---

# PixiShelf 本次上线后续待办事项

> **历史清单。** 旧消费者兼容清理已经随归档收件箱双 lane 切换推进；当前尚未完成的发布证据和数据库
> contract 技术债已收敛到根 [TODO](../../TODO.md)。本文中的 17 项 capability、旧镜像和
> `archive-worker` 操作只描述 2026-08-18 当时状态，不得作为当前部署步骤。

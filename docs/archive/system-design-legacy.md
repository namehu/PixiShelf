---
status: historical
scope: 旧版单应用分层与目录规范，仅用于追溯历史设计
last-verified: 2026-08-18
replaced-by: ../architecture/current-architecture.md
---

# PixiShelf 旧版系统设计与目录结构规范

> 本文基于已经不存在的 `packages/pixishelf/src/` 目录和旧单应用分层，不代表当前实现。
> 当前事实请阅读[当前架构](../architecture/current-architecture.md)。

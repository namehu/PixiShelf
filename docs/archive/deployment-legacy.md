---
status: historical
scope: 旧版 Vite/API-Web 拆分部署说明，仅用于追溯历史
last-verified: 2026-08-18
replaced-by: ../operations/deployment.md
---

# PixiShelf 旧版部署指南

> 本文包含已退役的 `packages/web`、Vite 和 API/Web 双镜像流程，不得用于当前部署。
> 当前流程请阅读[部署基线](../operations/deployment.md)。
